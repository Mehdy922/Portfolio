...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/30 relative overflow-hidden">
        ...
        <div className="grid grid-cols-12 gap-8 items-center w-full">
          ...
          <div className="col-span-1 flex flex-col items-center space-y-6">
            ...
            <div className="flex flex-col gap-6">
              <a 
                href="mailto:mehdy922@gmail.com" 
              ...
              <a 
                href="https://github.com/Mehdy922" 
                target="_blank"
              ...
              <a 
                href="https://www.linkedin.com/in/muhammadmehdy/" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                aria-label="LinkedIn"
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground max-w-md animate-fade-in-up delay-200">
                  Computer Science graduate from FAST-NUCES with expertise in AI, product management, and full-stack development. Dean's List achiever passionate about building scalable solutions.
                </p>
              </div>
      ...
      <div className="absolute bottom-8 left-20 text-muted-foreground animate-bounce">
        <button 
          onClick={() => scrollToSection('about')}
